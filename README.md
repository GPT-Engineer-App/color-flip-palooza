...
**Project**: color-flip-palooza 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a web application with a simple UI where a user can upload a jpg image from their computer and the app inverts all colors of those images and displays it 
...
```sh
git clone https://github.com/GPT-Engineer-App/color-flip-palooza.git
cd color-flip-palooza
npm i
